 ...
 */
add_action('after_setup_theme','cod2_theme_setup');
function cod2_theme_setup(): void {
	add_theme_support( 'menus' );
  add_theme_support( 'editor-styles' );
	load_theme_textdomain( 'codium-2', get_parent_theme_file_path() . '/languages' ); // Loads our PHP translation files.
}
 ...
 */
add_action('wp_head','cod2_wp_head');
function cod2_wp_head(): void {}

/**
 * Need something added directly to the footer?
 * https://developer.wordpress.org/reference/hooks/wp_footer/
 */
add_action('wp_footer','cod2_wp_footer');
function cod2_wp_footer(): void {}
 ...
 */
add_action( 'wp_body_open', 'cod2_wp_body_open' );
function cod2_wp_body_open(): void {}
 ...
 */
add_action( 'init', 'cod2_jetpack_remove_share' );
function cod2_jetpack_remove_share(): void {
