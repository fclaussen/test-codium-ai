 ...
 */
add_action('after_setup_theme','cod_editor_styles');
function cod_editor_styles(): void {
...
add_action( 'wp_enqueue_scripts', 'cod_enqueue_scripts' ); // Loads our css in the front end.
function cod_enqueue_scripts(): void {
	/**
 ...
 */
// add_action( 'enqueue_block_editor_assets', 'cod_enqueue_editor_scripts' );
// function cod_enqueue_editor_scripts(): void {
// 	if (
